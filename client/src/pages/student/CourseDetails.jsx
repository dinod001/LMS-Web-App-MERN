    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p>
            Course by{" "}
            <span className="text-blue-600 underline">CodeSage LK</span>
          </p>
          ...
          {/*course description*/}
          <div className="py-20  md:text-default">
            ...
            <div className="p-5">
              ...
              <div className="pt-6">
                ...
                <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                  ...
                  <li>Step by setp, hands on project guidance</li>
                  <li>Downloadble resource and source code</li>
                  <li>Quizess test your knowledge</li>
